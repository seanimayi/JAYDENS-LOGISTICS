import { MdAccountCircle,  MdNotifications, MdPostAdd, MdSearch } from "react-icons/md";

export default function Header() {
  return (
    <>
      <div className="p-[1rem] z-20 sticky top-0 left-0 w-full bg-white rounded-tr-[30px] shadow-sm flex items-center justify-between">
        ...
        <div className="flex items-center justify-between gap-5">
            <button className="btn bg-blue-600 text-white"><MdPostAdd size={20}/></button>
